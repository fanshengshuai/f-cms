...
<body>
<nav class="breadcrumb"><i class="f-ui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 用户中心 <span class="c-gray en">&gt;</span> 用户通信 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="f-ui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg">
            ...
            <tr class="text-c">
                ...
                <td><{$vo.time}></td>
                <td>
                    <a title="查看" href="javascript:;" onclick="member_edit('管理员查看','/admin/Member/edit_message?a_id=<{$vo.id}>','<{$vo.id}>','800','400')" class="ml-5" style="text-decoration:none"><i class="f-ui-iconfont">&#xe631;</i></a>
                </td>
            </tr>
            <{/foreach}>
            </tbody>

...
<div class="pd-20">
    <form action="/admin/about/ins" name="myform" method="post" class="form form-horizontal" id="form-article-add"
          enctype="multipart/form-data">
        <div class="row cl">
            <label class="form-label col-1"><span class="c-red">*</span>内容：</label>

            <div class="formControls col-10">
                <!--                <input type="text" class="input-text" placeholder="" id="" name="content">-->
                <script
                    id="editor" type="text/plain"name="content"  style="width:100%; height:600px;"><?php echo $info['summary']; ?></script>
            </div>
        </div>
        <div class="row cl">
            <div class="col-10 col-offset-1">
                <input type="hidden" value="1" name="type">
                <button onClick="" class="btn btn-primary radius" type="submit"><i class="f-ui-iconfont">&#xe632;</i>
                    保存并提交
                </button>

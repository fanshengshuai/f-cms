...
{/if}
<nav class="breadcrumb"><i class="f-ui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 新闻中心 <span
        class="c-gray en">&gt;</span> {if $type==4}公司新闻{else}企业动态{/if} <a class="btn btn-success radius r mr-20"
                                                                                style="line-height:1.6em;margin-top:3px"
                                                                                href="javascript:location.replace(location.href);"
                                                                                title="刷新"><i class="f-ui-iconfont">
            &#xe68f;</i></a></nav>
<div class="pd-20">
            ...
            <tr class="text-c">
                ...
                <td class="f-14 td-manage">
                    <a style="text-decoration:none" class="ml-5" href="/admin/Article/edit?id=<?php echo $item['id'];?>"
                       title="编辑"><i class="f-ui-iconfont">&#xe6df;</i></a>
                    <a style="text-decoration:none" class="ml-5" onClick="article_del(this,'<?php echo $item['id'];?>')"
                       href="javascript:;" title="删除"><i class="f-ui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
            {/foreach}
            </tbody>

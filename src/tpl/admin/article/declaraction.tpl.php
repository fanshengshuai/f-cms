...
<div class="pd-20">
    <form action="/admin/article/declaraction_add" name="myform" method="post" class="form form-horizontal" id="form-article-add"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                ...
                <script id="editor" type="text/plain" name="content" style="width:100%;height:600px;"><?php echo $info['content'];?>></script>
            </div>
        </div>
        <div class="row cl">

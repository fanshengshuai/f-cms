...
<div class="pd-20">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="f-ui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius"  href="/admin/product/add"><i class="f-ui-iconfont">&#xe600;</i> 添加产品</a></span> <span class="r">共有数据：<strong><?php echo $page_info['total'];?></strong> 条</span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $item['summary|strip_tags|truncate:30'];?></td>
                <td><?php echo $item['create_time'];?></td>
                <td class="f-14 td-manage">
                    <a style="text-decoration:none" class="ml-5"  href="/admin/product/edit?id=<?php echo$item['id'];?>" title="编辑"><i class="f-ui-iconfont">&#xe6df;</i></a>
                    <a style="text-decoration:none" class="ml-5" onClick="about_del(this,'<?php echo $item['id'];?>')" href="javascript:;" title="删除"><i class="f-ui-iconfont">&#xe6e2;</i></a>
                </td>
            </tr>
            {/foreach}
            </tbody>
...
<script type="text/javascript">
    ...
    function about_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            $.post('/admin/product/del',{id:id},function(data){
                if(data == 1) {
    ...
    function datadel(){
        ...
        $.post('/admin/product/del',{a_id:aa},function(data){
            if(data == 1) {

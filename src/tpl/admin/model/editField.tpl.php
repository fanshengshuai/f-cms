    ...
    <form action="" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-6">
                        <input type="text" class="input-text" value="{$catData.0}" placeholder="" id="field_name" name="field_name" datatype="*2-16">
                    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-6">
                        <input type="text" class="input-text" value="{$catData.1}" placeholder="" id="field_type" name="field_type" datatype="*2-16">
                    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-6">
                        <input type="text" class="input-text" value="{$catData.2}" placeholder="" id="field_summary" name="field_summary" datatype="*2-16">
                    </div>
        ...
        <div class="row cl">
            <div class="col-9 col-offset-3">
                ...
                <input type="hidden" name="field_name_old" value="{$catData.0}"/>
                <input type="hidden" name="field_type_old" value="{$catData.1}"/>
